...
let filteredList = simpleList.filter(simpleList);
...
//let hikeQuery = 'fall';
//let filterdHikes = hikes.filter(function(hike){
  //  return hike.name.toLowerCase.includes(hikeQuery.toLocaleLowerCase)

//})
//console.log(filterdHikes)
